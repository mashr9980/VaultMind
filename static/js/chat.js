...
async function loadKnowledgeBaseStatus() {
    try {
        ...
        if (kbStatus.status === 'empty') {
            ...
            chatMessages.innerHTML = `
                <div class="welcome-message">
                    ...
                    <div class="message-content">
                        <p>Hello! I'm VaultMind, your Enterprise Support Assistant.</p>
            ...
            document.getElementById('chat-title').textContent = `VaultMind Assistant - Knowledge Base`;
            updateChatStatus(`Ready to chat - VaultMind Knowledge Base: ${kbStatus.total_documents} documents, ${kbStatus.total_chunks} knowledge chunks`);
            enableChatInput();
        }
...
async function loadChatSession(sessionId) {
    try {
        ...
        if (session) {
            document.getElementById('chat-title').textContent = `${session.session_name} - VaultMind Expert`;
        }
...
function addWelcomeMessage() {
    ...
    welcomeDiv.innerHTML = `
        ...
        <div class="message-content">
            <p>Hello! I'm your VaultMind Expert Assistant. I'm ready to help you with VaultMind ERP systems.</p>
...
function startAssistantMessage() {
    ...
    content.innerHTML = `
        <div class="typing-indicator">
            <span>VaultMind is thinking</span>
...
function enableChatInput() {
    ...
    if (chatInput) {
        ...
        chatInput.placeholder = "Ask me anything about VaultMind systems...";
    }
    if (sendBtn) {
